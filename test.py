...
if __name__ == "__main__":
    files = [
        ...
        "results/gemma-3n-E2B-it_cot_ufc.txt",
        "results/gemma-3n-E2B-it_cot_xd-violence.txt",
        "results/gemma-3n-E2B-it_fewshot_ufc.txt",
        "results/gemma-3n-E2B-it_fewshot_xd-violence.txt",
        "results/gemma-3n-E2B-it_zero_shot_ufc.txt",
        ...
        "results/Qwen2.5-VL-7B-Instruct_basic_xd-violence.txt",
        "results/Qwen2.5-VL-7B-Instruct_cot_xd-violence.txt",
        "results/Qwen2.5-VL-7B-Instruct_fewshot_xd-violence.txt",
        "results/Qwen2.5-VL-7B-Instruct_zero_shot_xd-violence.txt",
    ]
    for path in files:
        main(path)
